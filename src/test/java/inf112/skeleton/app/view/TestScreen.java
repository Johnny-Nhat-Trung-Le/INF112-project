...
//TROR DET GÅR AN Å mocke STAGE https://git.app.uib.no/inf112/24v/inf112-24v/-/wikis/notater/Testing-og-Mocking
public class TestScreen {
    ...
    static void setUpBeforeAll(){
        ...
        HeadlessApplication app = new HeadlessApplication(view);
    ...
    public void testStartState(){
        ...
        assertNotNull(Gdx.files.internal("src/main/resources/Pink_Monster/Pink_Monster.png"));
    }
    @Test
    public void testToActiveState(){
        GameState startGameState = model.getState();
        assertEquals(GameState.MAIN_MENU,startGameState);
        view.setScreen(new GameOverScreen(controller));
    }
    @Test
