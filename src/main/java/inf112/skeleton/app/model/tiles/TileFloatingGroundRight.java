...
public class TileFloatingGroundRight extends TileModel {

    public static void loadStatic(){}

    static {
        TileFactory.register('r', (world, eventBus, x, y) -> {
            return new TileFloatingGroundRight(world, x + TILE_WIDTH / 2, y + TILE_HEIGHT / 2, TILE_WIDTH, TILE_HEIGHT);
        });
    }
     ...
     */
    public TileFloatingGroundRight(World world, float x, float y, float w, float h) {
        super(world, x, y, w, h);
    }
}
