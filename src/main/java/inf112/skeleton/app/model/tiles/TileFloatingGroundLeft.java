...
public class TileFloatingGroundLeft extends TileModel {

    static {
        TileFactory.register('l', (world, eventBus, x, y) -> {
            return new TileFloatingGroundLeft(world, x + TILE_WIDTH / 2, y + TILE_HEIGHT / 2, TILE_WIDTH, TILE_HEIGHT);
        });
    }
     ...
     */
    public TileFloatingGroundLeft(World world, float x, float y, float w, float h) {
        super(world, x, y, w, h);
    }
