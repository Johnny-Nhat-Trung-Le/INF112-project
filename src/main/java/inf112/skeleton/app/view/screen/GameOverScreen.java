...
public class GameOverScreen implements Screen {
    ...
    public GameOverScreen(InputProcessor processor){
        ...
        //FIXME burde lage en egen png for GAMEOVER
    ...
    public void render(float delta) {
        ...
        font.draw(batch,"GAME OVER",(VIEWPORT_WIDTH/2), (VIEWPORT_HEIGHT/4)*3);
        font.draw(batch, "Press R to restart", VIEWPORT_WIDTH/2,(VIEWPORT_HEIGHT/4)*2);
        batch.end();
